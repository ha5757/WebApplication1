<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster1.Master" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="WebApplication1.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr><td>
        <asp:RadioButton ID="rdbdeptno" runat="server" GroupName="G1" Text="Deptno" OnCheckedChanged="rdbdeptno_CheckedChanged" AutoPostBack="True"/>
            ...
            <asp:DropDownList ID="ddldeptno" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddldeptno_SelectedIndexChanged">
