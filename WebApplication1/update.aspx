<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster1.Master" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="WebApplication1.update" %>
...
<table>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txthiredate" runat="server" ClientIDMode="Static" TextMode="Date"></asp:TextBox>
